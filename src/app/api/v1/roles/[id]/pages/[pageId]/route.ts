/**
 * @file roles/[id]/pages/[pageId]/route.ts
 * @description Route handler для снятия страницы с роли (DELETE)
 */
...
/**
 * @route DELETE /api/v1/roles/:id/pages/:pageId
 * @auth required
 * @role SUPER_ADMIN
 * @description Снимает страницу с роли
 *
...
async function handleDelete(_request: NextRequest, context: RouteContext) {
  try {
    ...
    await service.unassignPageFromRole(id, pageId);
