/**
 * @page /dashboard/comms/announcements
 * @auth required
 ...
 * - Клик по карточке → router.push('/dashboard/comms/announcements/:id')
...
export default function AnnouncementsPage(): React.JSX.Element {
  ...
  const handleAnnouncementClick = useCallback((id: string) => {
    router.push(`/dashboard/comms/announcements/${id}`);
  }, [router]);
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-[var(--theme-danger)]/10 border border-[var(--theme-danger)]/20 rounded-lg p-4 text-[var(--theme-danger)]">
